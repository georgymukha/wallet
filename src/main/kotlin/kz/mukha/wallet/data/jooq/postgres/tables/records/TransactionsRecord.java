...
public class TransactionsRecord extends UpdatableRecordImpl<TransactionsRecord> {
     ...
     */
    public TransactionsRecord(UUID transactionId, UUID walletId, String operationType, String description, LocalDateTime transactionDate, LocalDateTime createdAt, LocalDateTime updatedAt, String orgTitle, String retailPlaceAddress, LocalDateTime foundDate, String kkmFnsId, String fiscalId, BigDecimal totalSum) {
        super(Transactions.TRANSACTIONS);
